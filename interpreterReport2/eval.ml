...
let rec string_of_exval = function
  ...
  | ProcV (f , e , env) -> "<function>"
  (* ProcVの際、"function"と名付ける*)
    ...
    let arg = eval_exp env exp2 in
      (match funval with
          ProcV (id , body , env') ->
            ...
            let newenv = Environment.extend id arg !(env')(*ProcVの定義に合わせて更新*) in
...
let eval_decl env = function
    ...
    | RecDecl (id1 , id2 , e) ->
      ...
      let newenv =
        ...
        dummyenv := newenv;
        (id1 , newenv , ProcV(id2 , e , dummyenv))
    (*can evaluate RecDecl(id1 , id2 , e)*)
